...
*EmailControllerApi* | [**get_email_content_match**](docs/EmailControllerApi.md#get_email_content_match) | **Get** /emails/{emailId}/contentMatch | Get email content regex pattern match results. Runs regex against email body and returns match groups.
