...
*AliasControllerApi* | [**get_alias_verification**](docs/AliasControllerApi.md#get_alias_verification) | **Get** /aliases/{aliasId}/verification | Get validation result from alias verification
