...
*EmailControllerApi* | [**get_email_html_query**](docs/EmailControllerApi.md#get_email_html_query) | **Post** /emails/{emailId}/html-query | Parse and return text from an email, stripping HTML and decoding encoded characters
*EmailControllerApi* | [**get_email_text_lines**](docs/EmailControllerApi.md#get_email_text_lines) | **Post** /emails/{emailId}/text | Parse and return text from an email, stripping HTML and decoding encoded characters
...
*InboxControllerApi* | [**get_expired_inbox_record_by_id**](docs/InboxControllerApi.md#get_expired_inbox_record_by_id) | **Get** /inboxes/expired-records/{expiredId} | Get an expired inbox record
*InboxControllerApi* | [**get_expired_inbox_record_by_inbox_id**](docs/InboxControllerApi.md#get_expired_inbox_record_by_inbox_id) | **Get** /inboxes/{inboxId}/expired-record | Get expired inbox record for a previously existing inbox
*InboxControllerApi* | [**get_expired_inbox_records**](docs/InboxControllerApi.md#get_expired_inbox_records) | **Get** /inboxes/expired-records | List records of expired inboxes
