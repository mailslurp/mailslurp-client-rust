...
*AliasControllerApi* | [**reply_to_email**](docs/AliasControllerApi.md#reply_to_email) | **Put** /aliases/{aliasId}/emails/{emailId} | Reply to an email
...
*EmailControllerApi* | [**reply_to_email1**](docs/EmailControllerApi.md#reply_to_email1) | **Put** /emails/{emailId} | Reply to an email
