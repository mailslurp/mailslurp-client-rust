...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**inbox_ids** | Option<[**Vec<String>**](String.md)> | Optional set of inboxes to filter by. Only get the latest email from these inbox IDs |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**inbox_id** | Option<[**String**](.md)> | ID of the inbox you want to get the latest email from |  |
