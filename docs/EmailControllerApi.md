...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**email_id** | [**String**](.md) | ID of email to perform HTML query on | [required] |
**html_selector** | **String** | HTML selector to search for. Uses JQuery/JSoup/CSS style selector like '.my-div' to match content. See https://jsoup.org/apidocs/org/jsoup/select/Selector.html for more information. | [required] |

### Return type

[**crate::models::EmailTextLinesResult**](EmailTextLinesResult.md)
...
> crate::models::EmailTextLinesResult get_email_text_lines(decode_html_entities, email_id)
Parse and return text from an email, stripping HTML and decoding encoded characters
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**decode_html_entities** | **bool** | Decode HTML entities | [required] |
**email_id** | [**String**](.md) | ID of email to fetch text for | [required] |
...
**reply_to_email_options** | [**ReplyToEmailOptions**](ReplyToEmailOptions.md) | replyToEmailOptions | [required] |
