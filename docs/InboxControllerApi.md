...
> crate::models::Inbox create_inbox(description, email_address, expires_at, expires_in, favourite, name, tags, use_domain_pool)
...
> crate::models::ExpiredInboxDto get_expired_inbox_record_by_id(expired_id)
...
> crate::models::ExpiredInboxDto get_expired_inbox_record_by_inbox_id(inbox_id)
...
> crate::models::PageExpiredInboxRecordProjection get_expired_inbox_records(page, size, sort)
