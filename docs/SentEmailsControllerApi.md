...
> crate::models::PageTrackingPixelProjection get_all_sent_tracking_pixels(page, search_filter, size, sort)
...
> crate::models::PageTrackingPixelProjection get_sent_email_tracking_pixels(id, page, search_filter, size, sort)
