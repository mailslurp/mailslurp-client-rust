...
pub trait AliasControllerApi {
    fn create_alias(&self, create_alias_options: crate::models::CreateAliasOptions) -> Box<dyn Future<Item = crate::models::Alias, Error = Error<serde_json::Value>>>;
    ...
    fn get_alias_verification(&self, alias_id: &str, email_address: &str, verification_token: &str) -> Box<dyn Future<Item = crate::models::AliasVerificationResult, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>AliasControllerApi for AliasControllerApiClient<C> {
    ...
    fn get_alias_verification(&self, alias_id: &str, email_address: &str, verification_token: &str) -> Box<dyn Future<Item = crate::models::AliasVerificationResult, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/aliases/{aliasId}/verification".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
        ...
        ;
        req = req.with_query_param("emailAddress".to_string(), email_address.to_string());
        req = req.with_query_param("verificationToken".to_string(), verification_token.to_string());
        req = req.with_path_param("aliasId".to_string(), alias_id.to_string());
