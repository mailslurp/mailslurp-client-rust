...
pub trait AliasControllerApi {
    fn create_alias(&self, create_owned_alias_options: crate::models::CreateOwnedAliasOptions) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>>;
    fn create_anonymous_alias(&self, create_anonymous_alias_options: crate::models::CreateAnonymousAliasOptions) -> Box<dyn Future<Item = crate::models::Alias, Error = Error<serde_json::Value>>>;
    fn delete_alias(&self, alias_id: &str) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>>;
    fn get_alias(&self, alias_id: &str) -> Box<dyn Future<Item = crate::models::Alias, Error = Error<serde_json::Value>>>;
    ...
    fn update_alias(&self, alias_id: &str, create_owned_alias_options: crate::models::CreateOwnedAliasOptions) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>AliasControllerApi for AliasControllerApiClient<C> {
    fn create_alias(&self, create_owned_alias_options: crate::models::CreateOwnedAliasOptions) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        ;
        req = req.with_body_param(create_owned_alias_options);
    ...
    fn create_anonymous_alias(&self, create_anonymous_alias_options: crate::models::CreateAnonymousAliasOptions) -> Box<dyn Future<Item = crate::models::Alias, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/aliases/anonymous".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
        ...
        ;
        req = req.with_body_param(create_anonymous_alias_options);
