...
pub trait CommonActionsControllerApi {
    fn create_new_email_address(&self, use_domain_pool: bool) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
    fn create_new_email_address1(&self, use_domain_pool: bool) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>CommonActionsControllerApi for CommonActionsControllerApiClient<C> {
    fn create_new_email_address(&self, use_domain_pool: bool) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>> {
        ...
        ;
        req = req.with_query_param("useDomainPool".to_string(), use_domain_pool.to_string());
