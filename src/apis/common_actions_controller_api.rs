...
pub trait CommonActionsControllerApi {
    fn create_new_email_address(&self, expires_at: Option<String>, expires_in: Option<i64>, use_domain_pool: Option<bool>) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
    fn create_new_email_address1(&self, expires_at: Option<String>, expires_in: Option<i64>, use_domain_pool: Option<bool>) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
