...
pub trait EmailControllerApi {
    ...
    fn get_email_text_lines(&self, email_id: &str, decode_html_entities: Option<bool>) -> Box<dyn Future<Item = crate::models::EmailTextLinesResult, Error = Error<serde_json::Value>>>;
