...
pub trait FormControllerApi {
    fn submit_form(&self, _email_address: Option<&str>, _redirect_to: Option<&str>, _spam_check: Option<&str>, _subject: Option<&str>, _success_message: Option<&str>, _to: Option<&str>, other_parameters: Option<&str>) -> Box<dyn Future<Item = String, Error = Error<serde_json::Value>>>;
}
