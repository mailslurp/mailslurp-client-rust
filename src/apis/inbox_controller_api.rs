...
pub trait InboxControllerApi {
    fn create_inbox(&self, allow_team_access: Option<bool>, description: Option<&str>, email_address: Option<&str>, expires_at: Option<String>, expires_in: Option<i64>, favourite: Option<bool>, name: Option<&str>, tags: Option<Vec<String>>, use_domain_pool: Option<bool>) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
    ...
    fn get_all_inboxes(&self, favourite: Option<bool>, page: Option<i32>, search: Option<&str>, size: Option<i32>, sort: Option<&str>, tag: Option<&str>, team_access: Option<bool>) -> Box<dyn Future<Item = crate::models::PageInboxProjection, Error = Error<serde_json::Value>>>;
    ...
    fn get_organization_inboxes(&self, page: Option<i32>, size: Option<i32>, sort: Option<&str>) -> Box<dyn Future<Item = crate::models::PageOrganizationInboxProjection, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>InboxControllerApi for InboxControllerApiClient<C> {
    ...
    fn get_all_inboxes(&self, favourite: Option<bool>, page: Option<i32>, search: Option<&str>, size: Option<i32>, sort: Option<&str>, tag: Option<&str>, team_access: Option<bool>) -> Box<dyn Future<Item = crate::models::PageInboxProjection, Error = Error<serde_json::Value>>> {
        ...
        if let Some(ref s) = team_access {
            req = req.with_query_param("teamAccess".to_string(), s.to_string());
        }
    ...
    fn get_organization_inboxes(&self, page: Option<i32>, size: Option<i32>, sort: Option<&str>) -> Box<dyn Future<Item = crate::models::PageOrganizationInboxProjection, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/inboxes/organization".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
