...
pub trait InboxControllerApi {
    fn create_inbox(&self, description: Option<&str>, email_address: Option<&str>, expires_at: Option<String>, favourite: Option<bool>, name: Option<&str>, tags: Option<Vec<String>>, use_domain_pool: Option<bool>) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
