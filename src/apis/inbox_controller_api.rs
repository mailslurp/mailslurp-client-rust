...
pub trait InboxControllerApi {
    fn create_inbox(&self, description: Option<&str>, email_address: Option<&str>, expires_at: Option<String>, expires_in: Option<i64>, favourite: Option<bool>, name: Option<&str>, tags: Option<Vec<String>>, use_domain_pool: Option<bool>) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
    fn create_inbox_with_options(&self, create_inbox_dto: crate::models::CreateInboxDto) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>>;
    ...
    fn get_expired_inbox_record_by_id(&self, expired_id: &str) -> Box<dyn Future<Item = crate::models::ExpiredInboxDto, Error = Error<serde_json::Value>>>;
    fn get_expired_inbox_record_by_inbox_id(&self, inbox_id: &str) -> Box<dyn Future<Item = crate::models::ExpiredInboxDto, Error = Error<serde_json::Value>>>;
    fn get_expired_inbox_records(&self, page: Option<i32>, size: Option<i32>, sort: Option<&str>) -> Box<dyn Future<Item = crate::models::PageExpiredInboxRecordProjection, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>InboxControllerApi for InboxControllerApiClient<C> {
    ...
    fn create_inbox_with_options(&self, create_inbox_dto: crate::models::CreateInboxDto) -> Box<dyn Future<Item = crate::models::Inbox, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/inboxes/withOptions".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
        ...
        ;
        req = req.with_body_param(create_inbox_dto);
    ...
    fn get_expired_inbox_record_by_id(&self, expired_id: &str) -> Box<dyn Future<Item = crate::models::ExpiredInboxDto, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/inboxes/expired-records/{expiredId}".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
    ...
    fn get_expired_inbox_record_by_inbox_id(&self, inbox_id: &str) -> Box<dyn Future<Item = crate::models::ExpiredInboxDto, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/inboxes/{inboxId}/expired-record".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
    ...
    fn get_expired_inbox_records(&self, page: Option<i32>, size: Option<i32>, sort: Option<&str>) -> Box<dyn Future<Item = crate::models::PageExpiredInboxRecordProjection, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/inboxes/expired-records".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "x-api-key".to_owned(),
