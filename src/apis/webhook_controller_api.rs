...
/// struct for passing parameters to the method `redrive_webhook_result`
#[derive(Clone, Debug)]
...
/// struct for typed errors of method `get_test_webhook_payload_email_read`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `redrive_webhook_result`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
