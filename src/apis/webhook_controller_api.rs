...
pub async fn get_webhook_result(configuration: &configuration::Configuration, params: GetWebhookResultParams) -> Result<crate::models::WebhookResultEntity, Error<GetWebhookResultError>> {
    // unbox the parameters
