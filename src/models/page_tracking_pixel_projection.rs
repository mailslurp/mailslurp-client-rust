...
pub struct PageTrackingPixelProjection {
    #[serde(rename = "content", skip_serializing_if = "Option::is_none")]
    pub content: Option<Vec<crate::models::TrackingPixelProjection>>,
...
impl PageTrackingPixelProjection {
    ...
    pub fn new() -> PageTrackingPixelProjection {
