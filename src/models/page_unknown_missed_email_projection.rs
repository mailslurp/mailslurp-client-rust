...
pub struct PageUnknownMissedEmailProjection {
    #[serde(rename = "content", skip_serializing_if = "Option::is_none")]
    pub content: Option<Vec<crate::models::UnknownMissedEmailProjection>>,
...
impl PageUnknownMissedEmailProjection {
    ...
    pub fn new() -> PageUnknownMissedEmailProjection {
